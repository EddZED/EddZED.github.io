...
if($formGo) {
    ...
    if ( $formGo == 'callback' ) {
        $subject = "Заказ звонка (alfa)";
    }
	if ( $formGo == 'callback2' ) {
        $subject = "Заявка на осмотр объекта (alfa)";
    }
    ...
    if (!empty($org)) {
        $message .= "<tr>";
        $message .= "<td>";
        $message .= "<strong> Организация: </strong>";
        $message .= "</td>";
        $message .= "<td style='padding-left:12px;'>";
        $message .= "$org";
        $message .= "</td>";
    ...
    if (!empty($type)) {
        $message .= "<tr>";
        $message .= "<td>";
        $message .= "<strong> Тип объекта: </strong>";
        $message .= "</td>";
        $message .= "<td style='padding-left:12px;'>";
        $message .= "$type";
        $message .= "</td>";
    ...
    if (!empty($post)) {
        $message .= "<tr>";
        $message .= "<td>";
        $message .= "<strong> Количество постов: </strong>";
        $message .= "</td>";
        $message .= "<td style='padding-left:12px;'>";
        $message .= "$post";
        $message .= "</td>";
