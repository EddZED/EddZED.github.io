                ...
                $.ajax({
                    ...
                    success: function(res) {
                        if (res == 1) {
                            ...
                            $this.find('.form__hide-success').after('<div class="form__sys-message alert text-center"></div>');
                            $this.find('.form__sys-message').html('<div class="modal-header d-block text-center"><h4 class="modal-title">' + options.successTitle + '</h4><p class = "modal_sub_title px-3 m-0" >' + options.successText + '</p></div><div class="modal-footer d-flex justify-content-center pb-5"><ul class="list-unstyled justify-content-center w-100 align-items-center d-flex m-0 pr-lg-0"><li class="social_ikons pr-3"><a href="https://vk.com/volgaexpress" target="_blank" class="ikons"><i class="fab fa-vk"></i></a></li><li class="social_ikons pr-3"><a href="https://www.facebook.com/volgaexpress" target="_blank" class="ikons"><i class="fab fa-facebook-f"></i></a></li><li class="social_ikons"><a href="https://twitter.com/volgaexpress" target="_blank" class="ikons"><i class="fab fa-twitter"></i></a></li><li class="social_ikons pl-3"><a href="https://www.instagram.com/volga_express" target="_blank" class="ikons"><i class="fab fa-instagram"></i></a></li>	</ul></div>');
                            setTimeout(function() {
...
jQuery(document).ready(function($) {
    ...
    $('#callbackForm').simpleSendForm({
        successTitle: "THANK YOU!<br>OUR MANAGER WILL CONTACT YOU SOON!",
        successText: "In the meantime, we invite you to visit our social media accounts:",
        autoClose: true,
        autoCloseDelay: 5000,
        mailUrl: "submit.php"
		
    });
	$('#modalcallback').simpleSendForm({
        successTitle: "THANK YOU!<br>OUR MANAGER WILL CONTACT YOU SOON!",
        successText: "In the meantime, we invite you to visit our social media accounts:",
        autoClose: true,
        autoCloseDelay: 5000,
