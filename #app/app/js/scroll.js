var controller = new ScrollMagic.Controller();
	...
	if (widthw >= 1280) {
		$(function () {
			...
			new ScrollMagic.Scene({triggerElement: "#thirdSection", duration: 2000, offset: 0, triggerHook: 0})
				.setPin("#thirdSection")	
				.addTo(controller);
			new ScrollMagic.Scene({triggerElement: "#thirdSection", duration: 50, offset: 0, triggerHook: 0})
				.setClassToggle("#cont1", "show")			
				.setTween(TweenMax.from("#thirdSection", 1, {opacity: 0, y: -100}))
				.addTo(controller);
      ...
      //   };
			...
			new ScrollMagic.Scene({triggerElement: "#best_sales", duration: 200, offset: -200, triggerHook: 0.3})
			  ...
			  .addTo(controller);
			// new ScrollMagic.Scene({triggerElement: "#best_sales", duration: 400, offset: heightw/2, triggerHook: 0.7})
			...
			// new ScrollMagic.Scene({triggerElement: "#best_sales", duration: 400, offset: heightw/2, triggerHook: 0.5})
			...
			new ScrollMagic.Scene({triggerElement: "#about_us", duration: 300, offset: 0, triggerHook: 0.3})
				.setTween(TweenMax.from("#cont_item .block_item_about", 1, {opacity: 0, y: 600}))		
				.addTo(controller);
			new ScrollMagic.Scene({triggerElement: "#about_us", duration: 400, offset: 500, triggerHook: 0.1})
				.setTween(TweenMax.to("#cont_item .block_item_about", 1, {opacity: 0, y: -600}))		
				.addTo(controller);
		...
		new ScrollMagic.Scene({triggerElement: "#trust .wrap_company_block", duration: 300, offset: 280, triggerHook: 1})
			...
			new ScrollMagic.Scene({triggerElement: "#assortment", duration: 300, offset: 0, triggerHook: - heightw/2})
			.setPin("#assortment")
		...
		// 	.addTo(controller);
			...
			//		new ScrollMagic.Scene({triggerElement: "#flex4", duration: 512, offset: heightw/4})
			//					.setTween(timeline12)
			//					.addTo(controller);
			//	
		...
		$(function () {
			new ScrollMagic.Scene({triggerElement: "#test_section", duration: 300, offset: 0, triggerHook: 0.9})
				.setTween(TweenMax.from("#test_section h2.light_gray_title", 1, {opacity: 0, y: 100}))		
				.addTo(controller);
			new ScrollMagic.Scene({triggerElement: "#test_section", duration: 300, offset: 0, triggerHook: 0.8})
				.setTween(TweenMax.from("#test_section h3.title_block", 1, {opacity: 0, y: 100}))		
				.addTo(controller);
			new ScrollMagic.Scene({triggerElement: "#best_sales", duration: 300, offset: 0, triggerHook: 0.9})
				.setTween(TweenMax.from("#best_sales h2.light_gray_title", 1, {opacity: 0, y: 100}))		
			  .addTo(controller);
			new ScrollMagic.Scene({triggerElement: "#best_sales", duration: 300, offset: 0, triggerHook: 0.8})
				.setTween(TweenMax.from("#best_sales h3.title_block", 1, {opacity: 0, y: 100}))		
				.addTo(controller);
			new ScrollMagic.Scene({triggerElement: "#test_drive", duration: 300, offset: 0, triggerHook: 0.8})
				.setTween(TweenMax.from("#test_drive h3.title_block", 1, {opacity: 0, y: 100}))		
				.addTo(controller);
			new ScrollMagic.Scene({triggerElement: "#test_drive", duration: 300, offset: 0, triggerHook: 0.9})
				.setTween(TweenMax.from("#test_drive h2.light_gray_title", 1, {opacity: 0, y: 100}))		
				.addTo(controller);
			new ScrollMagic.Scene({triggerElement: "#about_us", duration: 300, offset: 0, triggerHook: 0.8})
				.setTween(TweenMax.from("#about_us h3.title_block", 1, {opacity: 0, y: 100}))		
				.addTo(controller);
			new ScrollMagic.Scene({triggerElement: "#about_us", duration: 300, offset: 0, triggerHook: 0.9})
				.setTween(TweenMax.from("#about_us h2.light_gray_title", 1, {opacity: 0, y: 100}))		
				.addTo(controller);
			new ScrollMagic.Scene({triggerElement: "#recomend_reading", duration: 300, offset: 0, triggerHook: 0.8})
				.setTween(TweenMax.from("#recomend_reading h3.title_block", 1, {opacity: 0, y: 100}))		
				.addTo(controller);
			new ScrollMagic.Scene({triggerElement: "#recomend_reading", duration: 300, offset: 0, triggerHook: 0.9})
				.setTween(TweenMax.from("#recomend_reading h2.light_gray_title", 1, {opacity: 0, y: 100}))		
				.addTo(controller);
			new ScrollMagic.Scene({triggerElement: "#assortment", duration: 300, offset: 0, triggerHook: 0.8})
				.setTween(TweenMax.from("#assortment h3.title_block", 1, {opacity: 0, y: 100}))		
				.addTo(controller);
			new ScrollMagic.Scene({triggerElement: "#assortment", duration: 300, offset: 0, triggerHook: 0.9})
				.setTween(TweenMax.from("#assortment h2.light_gray_title", 1, {opacity: 0, y: 100}))		
				.addTo(controller);
			new ScrollMagic.Scene({triggerElement: "#filials", duration: 300, offset: 0, triggerHook: 0.8})
				.setTween(TweenMax.from("#filials h3.title_block", 1, {opacity: 0, y: 40}))		
				.addTo(controller);
			new ScrollMagic.Scene({triggerElement: "#filials", duration: 400, offset: 0, triggerHook: 0.9})
				.setTween(TweenMax.from("#filials h2.light_gray_title", 1, {opacity: 0, y: 100}))		
				.addTo(controller);
			// new ScrollMagic.Scene({triggerElement: "#map", duration: 300, offset: 0, triggerHook: 0.9})
			// .setTween(TweenMax.from("#map h2.gray", 1, {opacity: 0, y: 100}))
			// .addTo(controller);
			// new ScrollMagic.Scene({triggerElement: "#map", duration: 300, offset: 0, triggerHook: 0.8})
		...
		new ScrollMagic.Scene({triggerElement: "#trust .wrap_company_block", duration: 300, offset: 0, triggerHook: .8})
			...
			new ScrollMagic.Scene({triggerElement: "#recomend_reading", duration: 300, offset: 0, triggerHook: 0.8})
				...
				.addTo(controller);
			new ScrollMagic.Scene({triggerElement: "#call_us", duration: 300, offset: 0, triggerHook: 0.8})
				.setTween(TweenMax.from("#call_us", 1, {opacity: 0, y: 100}))		
				.addTo(controller);
			new ScrollMagic.Scene({triggerElement: "#assortment", duration: 300, offset: 0, triggerHook: 0.8})
				.setTween(TweenMax.from("#assortment", 1, {opacity: 0, y: 100}))		
				.addTo(controller);
			new ScrollMagic.Scene({triggerElement: "#about", duration: 300, offset: 0, triggerHook: 0.8})
				.setTween(TweenMax.from("#about", 1, {opacity: 0, y: 100}))		
				.addTo(controller);
			new ScrollMagic.Scene({triggerElement: "#filials", duration: 300, offset: 0, triggerHook: 0.8})
				.setTween(TweenMax.from("#filials", 1, {opacity: 0, y: 100}))		
				.addTo(controller);
			new ScrollMagic.Scene({triggerElement: "#filials .city_list", duration: 200, offset: 0, triggerHook: 0.8})
				.setTween(TweenMax.from("#filials .text_content", 1, {opacity: 0, y: 50}))		
				.addTo(controller);
			new ScrollMagic.Scene({triggerElement: "#banner_sldiers_section", duration: 200, offset: 0, triggerHook: 0.8})
				.setTween(TweenMax.from("#banner_sldiers_section", 1, {opacity: 0, y: 100}))		
				.addTo(controller);
		});	
	};
