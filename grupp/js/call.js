...
jQuery(document).ready(function($) {
    ...
    $('#feedbackForm').simpleSendForm({
        successTitle: "Ваш отзыв успешно отправлен!",
        successText: "Мы благодарим Вас за оставленное мнение.",
        captcha: false,
        mailUrl: "../submit.php"
    });
	...
	$('#zakazbackForm').simpleSendForm({
        successTitle: "Ваша заявка на скидку успешно отправлена!",
        successText: "Наш сотрудник свяжется с Вами в самое ближайшее время.",
        autoClose: true,
        autoCloseDelay: 5000,
        mailUrl: "/submit.php",
